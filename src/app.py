...
from src.models import Estudiante, Curso, Inscripcion
...
def formulario_estudiante():
    ...
    with st.form("form_estudiante"):
        ...
        fecha_nac = st.date_input("Fecha de nacimiento", max_value=datetime.now())
        carnet = st.text_input("Carnet (Formato A-XXXX-YYYY)")
